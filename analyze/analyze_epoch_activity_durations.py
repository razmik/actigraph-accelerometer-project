...
epoch_filename = "D:\Accelerometer Data\ActilifeProcessedEpochs\LSM2\Week 1\Wednesday/processed/LSM204_LSM2_Week_1_Wednesday_(2016-11-02).csv".replace('\\', '/')
...
print(epoch_start, (epoch_start+epoch_row_count))
