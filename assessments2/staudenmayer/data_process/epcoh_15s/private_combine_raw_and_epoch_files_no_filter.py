...
def process_without_filter(starting_row, end_row, experiment, week, day, user, date, epoch, device='Wrist'):
    ...
    epoch_filename = "D:\Accelerometer Data\ActilifeProcessedEpochs/" + epoch + "/" + experiment + "/" + week + "/" + day + "/processed_1min_ref/" + user + "_" + experiment + "_" + week.replace(
        ' ', '_') + "_" + day + "_" + date + "15s.csv".replace('\\', '/')
    ...
    epoch_data.columns = ['actilife_waist_AxisX', 'actilife_waist_AxisY', 'actilife_waist_AxisZ',
                          'actilife_waist_vm_60', 'actilife_waist_vm_cpm', 'actilife_waist_cpm', 'waist_ee', 'actilife_waist_intensity']
