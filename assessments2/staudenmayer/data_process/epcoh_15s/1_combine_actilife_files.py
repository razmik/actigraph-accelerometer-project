...
hip_key = 'Waist'
epoch_start_rows = 10
path = "D:/Accelerometer Data/ActilifeProcessedEpochs/Epoch15/" + experiment + "/" + week + "/" + day + "".replace('\\', '/')
output_folder = "D:/Accelerometer Data/ActilifeProcessedEpochs/Epoch15/" + experiment + "/" + week + "/" + day + "/processed".replace(
    '\\', '/')
