...
predictions_folder = ('D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/30sec/result_files/').replace('\\', '/')
output_folder = ('D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/30sec/combined/').replace('\\', '/')
...
if len(epoch_data_files) == len(prediction_data_files) or True:
