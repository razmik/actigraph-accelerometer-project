...
wrist = 'right_wrist'
print('Montoye 2016 ANN', wrist)
result_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/30sec/combined/'.replace('\\', '/')
...
#     temp = pd.read_csv(result_folder + file)
#     count = 0
#     for val in temp['actual_category']:
#         if math.isnan(val):
#             print(file, count)
#         count += 1
#
#     count = 0
#     for val in temp['predicted_category']:
#         if math.isnan(val):
#             print(file, count)
#         count += 1
#
