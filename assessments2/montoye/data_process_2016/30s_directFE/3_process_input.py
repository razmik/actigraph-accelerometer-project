...
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Montoye_2016_predictions/'+wrist+'/30sec/input_files/'.replace('\\', '/')
fe_files_path = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\FE_30_processed/wrist/'.replace('\\', '/')
...
for file in fe_files:
    ...
    if wrist == 'left_wrist':
        ...
        result_data['TenPct_GEleftX'] = fe_data['X10Perc']
        result_data['TenPct_GEleftY'] = fe_data['Y10Perc']
        result_data['TenPct_GEleftZ'] = fe_data['Z10Perc']
        result_data['TwentyFivePct_GEleftX'] = fe_data['X25Perc']
        result_data['TwentyFivePct_GEleftY'] = fe_data['Y25Perc']
        result_data['TwentyFivePct_GEleftZ'] = fe_data['Z25Perc']
        result_data['FiftyPct_GEleftX'] = fe_data['X50Perc']
        result_data['FiftyPct_GEleftY'] = fe_data['Y50Perc']
        result_data['FiftyPct_GEleftZ'] = fe_data['Z50Perc']
        result_data['SeventyFivePct_GEleftX'] = fe_data['X75Perc']
        result_data['SeventyFivePct_GEleftY'] = fe_data['Y75Perc']
        result_data['SeventyFivePct_GEleftZ'] = fe_data['Z75Perc']
        result_data['NinetyPct_GEleftX'] = fe_data['X90Perc']
        result_data['NinetyPct_GEleftY'] = fe_data['Y90Perc']
        result_data['NinetyPct_GEleftZ'] = fe_data['Z90Perc']
