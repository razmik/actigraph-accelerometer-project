...
predictions_folder = ('D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/60sec/result_files/').replace('\\', '/')
output_folder = ('D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/60sec/combined/').replace('\\', '/')
