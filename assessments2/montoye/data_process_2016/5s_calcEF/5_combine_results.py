...
epoch_folder = 'D:\Accelerometer Data\Processed\LSM2\Week 1\Wednesday/not_filtered\epoch_5\montoye_2016/'.replace('\\', '/')
predictions_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Montoye_2016_predictions/'+wrist+'/5sec/result_files/'.replace('\\', '/')
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Montoye_2016_predictions/'+wrist+'/5sec/combined/'.replace('\\', '/')
...
def met_to_intensity(row):
    ee = result_data['actilife_waist_ee'][row.name]
