...
wrist = 'left_wrist'
print('Montoye 2016 ANN 5s epochs', wrist)
result_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2\Montoye_2016_predictions/'+wrist+'/5sec/combined/'.replace('\\', '/')
