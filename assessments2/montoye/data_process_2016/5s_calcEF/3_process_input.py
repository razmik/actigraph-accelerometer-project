...
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Montoye_2016_predictions/'+wrist+'/5sec/input_files/'.replace('\\', '/')
fe_files_path = 'D:/Accelerometer Data/Processed/LSM2/Week 1/Wednesday/not_filtered/epoch_5/montoye_2016/'.replace('\\', '/')
...
for file in fe_files:
    ...
    if wrist == 'left_wrist':
        ...
        columns = ['TenPct_GEleftX', 'TenPct_GEleftY', 'TenPct_GEleftZ', 'TwentyFivePct_GEleftY',
                   'TwentyFivePct_GEleftZ', 'FiftyPct_GEleftX', 'FiftyPct_GEleftY', 'FiftyPct_GEleftZ',
                   'SeventyFivePct_GEleftX', 'SeventyFivePct_GEleftY', 'SeventyFivePct_GEleftZ', 'NinetyPct_GEleftX',
                   'NinetyPct_GEleftY', 'NinetyPct_GEleftZ']
        ...
        columns = ['TenPct_GErightX', 'TenPct_GErightY', 'TenPct_GErightZ', 'TwentyFivePct_GErightY',
                   'TwentyFivePct_GErightZ', 'FiftyPct_GErightX', 'FiftyPct_GErightY', 'FiftyPct_GErightZ',
                   'SeventyFivePct_GErightX', 'SeventyFivePct_GErightY', 'SeventyFivePct_GErightZ',
                   'NinetyPct_GErightX', 'NinetyPct_GErightY', 'NinetyPct_GErightZ']
