...
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2016_predictions/'+wrist+'/5sec/input_files/'.replace('\\', '/')
fe_files_path = 'D:\Accelerometer Data\Assessment\montoye\LSM2\Week 1\Wednesday\Epoch5/'.replace('\\', '/')
