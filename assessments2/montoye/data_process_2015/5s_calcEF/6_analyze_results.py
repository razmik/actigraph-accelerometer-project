...
result_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Montoye_2016_predictions/5sec/combined/'.replace('\\', '/')
...
#         predicted_intensity = results['montoye_2015_hip_predicted_intensity_by_ee']
#
...
#         # print("Montoye 2015 ANN (Intensity) measures:", precision_recall_fscore_support(target_intensity, predicted_intensity, average='macro'))
