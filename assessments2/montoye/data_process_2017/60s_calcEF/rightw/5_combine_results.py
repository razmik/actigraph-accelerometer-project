...
epoch_folder = 'D:\Accelerometer Data\Assessment\montoye\LSM2\Week 1\Wednesday\Epoch60/'.replace('\\', '/')
predictions_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2017_predictions/'+wrist+'/60sec/'+model+'/result_files/'.replace('\\', '/')
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2017_predictions/'+wrist+'/60sec/'+model+'/combined/'.replace('\\', '/')
