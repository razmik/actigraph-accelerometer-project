...
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2017_predictions/'+wrist+'/30sec/input_files/'.replace('\\', '/')
...
for file in fe_files:
    ...
    if wrist == 'left_wrist':
        ...
        result_data['VisitTime'] = (result_data.index+1) * 30
