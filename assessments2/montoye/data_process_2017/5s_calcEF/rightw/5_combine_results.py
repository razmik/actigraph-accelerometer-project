...
predictions_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2017_predictions/'+wrist+'/5sec/'+model+'/result_files/'.replace('\\', '/')
output_folder = 'D:\Accelerometer Data\Montoye\Features\LSM2\Week 1\Wednesday\Assessment2/Montoye_2017_predictions/'+wrist+'/5sec/'+model+'/combined/'.replace('\\', '/')
