...
def evaluate_models(data, status):
    ...
    Assessment data
    """
    target_ee = data['actilife_waist_intensity']
...
if __name__ == '__main__':
    ...
    """
    !Warning!
    Please note that the actilife_waist_intensity and actilife_waist_ee columns are interchanged in the data file.
    Please verify prior to assessments.
    """
