...
def process_with_filter(starting_row, end_row, experiment, week, day, user, date, device='Wrist'):
    ...
    epoch_filename = ("D:\Accelerometer Data\ActilifeProcessedEpochs/Epoch5/" + experiment + "/" + week + "/" + day
                      + "/processed/" + user + "_Epoch5_" + experiment + "_" + week.replace(' ', '_') + "_" + date + ".csv").replace('\\', '/')
